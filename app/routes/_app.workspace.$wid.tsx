...
export default function WorkspaceLayout() {
  ...
  function handleCreateDocument() {
    setShowNewMenu(false);
    // If there are folders, create in the first one. Otherwise create a folder first.
    if (folders.length > 0) {
      fetcher.submit(
        { intent: "create-document", folderId: folders[0].id, title: "Untitled" },
        { method: "post" },
      );
    }
  }
                  ...
                  {showNewMenu && (
                    <div className="absolute left-0 top-full z-50 mt-1 w-48 rounded-lg border border-zinc-200 bg-white py-1 shadow-lg">
                      <button
                        ...
                        className="flex w-full items-center gap-2.5 px-3 py-2 text-sm text-zinc-700 transition-colors hover:bg-zinc-50 disabled:opacity-40"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-zinc-400">
